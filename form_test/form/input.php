          ...
          <div class="col-md-6">
            ...
            <form method="POST" action="input.php">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="your_name" name="your_name" value="<?php if(!empty($_POST['your_name'])){echo h($_POST['your_name']);} ?>">
              </div>
              ...
              <div class="form-check form-check-inline">
                <label class="form-check-label">性別</label>
              ...
              <div class="form-group">
                ...
                <select class="form-control" id="age" name="age" id="">
